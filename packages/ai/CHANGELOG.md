...
- Fixed standard Xiaomi MiMo API-key validation to use `mimo-v2.5`, matching the upstream-supported model and Token Plan validation. ([#4062](https://github.com/can1357/oh-my-pi/issues/4062))
